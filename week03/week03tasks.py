...
spot_mrt={}
with open ("spot.csv","w",newline="",encoding="utf-8") as file_spot:
...
with open ("mrt.csv",mode="w",newline="",encoding="utf-8") as file_mrt:
    writer=csv.writer(file_mrt)
...
#     with open ("article.csv",mode="a",newline="",encoding="utf-8",) as article:
